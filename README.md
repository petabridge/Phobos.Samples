...
This solution contains a number of ready-made solution for testing [Phobos](https://phobos.petabridge.com/) in a real production environment.
Please read the README.md file inside each project folders for a more detailed usage of each projects.
...
This will create all the Docker images for all the projects, needed to run inside Kubernetes.

### Deploying the K8s Cluster (with Telemetry Installed)
To actually deploy the cluster, please read the README.md files inside each project folder.
